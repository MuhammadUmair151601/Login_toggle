        ...
        {isLogin ? (
          <>
            <div className="flex flex-col justify-center items-center">
              ...
              <input
                className="bg-gray-500 w-70 px-5 text-white rounded-[5px] py-2 mt-4"
                type="email"
                placeholder="Email"
              />
              <input
              ...
              <button
                className="bg-blue-950 w-30 text-white font-bold text-xl rounded-[7px] py-1 mt-3 cursor-pointer"
                type="submit"
              >
                Login
              </button>
          ...
          <>
            <div className="flex flex-col justify-center items-center">
              ...
              />
              <button
                className="bg-blue-950 w-30 text-white font-bold text-xl rounded-[7px] py-1 mt-3 cursor-pointer mb-5"
                type="submit"
              >
                SignUp
              </button>
